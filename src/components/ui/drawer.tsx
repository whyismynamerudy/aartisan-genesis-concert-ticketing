...
const Drawer = ({
  ...
  const {
    ref,
    aiProps
  } = useAIEnhanced("Drawer", {
    purpose: "ui-component",
    interactions: []
  });
  return <DrawerPrimitive.Root shouldScaleBackground={shouldScaleBackground} {...props} ref={ref} {...aiProps} />;
};
...
const DrawerHeader = ({
  ...
  const {
    ref,
    aiProps
  } = useAIEnhanced("DrawerHeader", {
    purpose: "page-header",
    interactions: []
  });
  return <div className={cn("grid gap-1.5 p-4 text-center sm:text-left", className)} {...props} ref={ref} {...aiProps} />;
};
...
const DrawerFooter = ({
  ...
  const {
    ref,
    aiProps
  } = useAIEnhanced("DrawerFooter", {
    purpose: "page-footer",
    interactions: []
  });
  return <div className={cn("mt-auto flex flex-col gap-2 p-4", className)} {...props} ref={ref} {...aiProps} />;
};
