...
const DialogHeader = ({
  ...
  const {
    ref,
    aiProps
  } = useAIEnhanced("DialogHeader", {
    purpose: "page-header",
    interactions: []
  });
  return <div className={cn("flex flex-col space-y-1.5 text-center sm:text-left", className)} {...props} ref={ref} {...aiProps} />;
};
