...
const BreadcrumbSeparator = ({
  ...
  const {
    ref,
    aiProps
  } = useAIEnhanced("BreadcrumbSeparator", {
    purpose: "ui-component",
    interactions: []
  });
  return <li role="presentation" aria-hidden="true" className={cn("[&>svg]:size-3.5", className)} {...props} ref={ref} {...aiProps}>
...
const BreadcrumbEllipsis = ({
  ...
  const {
    ref,
    aiProps
  } = useAIEnhanced("BreadcrumbEllipsis", {
    purpose: "ui-component",
    interactions: []
  });
  return <span role="presentation" aria-hidden="true" className={cn("flex h-9 w-9 items-center justify-center", className)} {...props} ref={ref} {...aiProps}>
