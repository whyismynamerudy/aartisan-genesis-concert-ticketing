...
const AlertDialogHeader = ({
  ...
  const {
    ref,
    aiProps
  } = useAIEnhanced("AlertDialogHeader", {
    purpose: "page-header",
    interactions: []
  });
  return <div className={cn("flex flex-col space-y-2 text-center sm:text-left", className)} {...props} ref={ref} {...aiProps} />;
};
...
const AlertDialogFooter = ({
  ...
  const {
    ref,
    aiProps
  } = useAIEnhanced("AlertDialogFooter", {
    purpose: "page-footer",
    interactions: []
  });
  return <div className={cn("flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-2", className)} {...props} ref={ref} {...aiProps} />;
};
